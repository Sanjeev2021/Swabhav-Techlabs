...
type Repository interface {
	...
	GetRecordForAdmin(uow *UnitOfWork, ID uint, out interface{}, queryProcessors ...QueryProcessor) error
	GetRecordForBank(uow *UnitOfWork, ID uint, out interface{}, queryProcessors ...QueryProcessor) error
	GetRecordForAccount(uow *UnitOfWork, ID uint, out interface{}, queryProcessors ...QueryProcessor) error
}
...
func DoesRecordExistForAdmin(db *gorm.DB, ID uint, out interface{}, queryProcessors ...QueryProcessor) (bool, error) {
	if ID == 0 {
		return false, errors.NewValidationError("DoesRecordExistForTenant: Invalid tenant ID")
	}
	count := 0
...
func (repository *GormRepository) GetRecordForAdmin(uow *UnitOfWork, ID uint, out interface{}, queryProcessors ...QueryProcessor) error {
	queryProcessors = append([]QueryProcessor{Filter("id = ?", ID)}, queryProcessors...)
	return repository.GetRecord(uow, out, queryProcessors...)
}

func DoesRecordExistForBank(db *gorm.DB, ID uint, out interface{}, queryProcessors ...QueryProcessor) (bool, error) {
	if ID == 0 {
		return false, errors.NewValidationError("DoesRecordExistForTenant: Invalid tenant ID")
	}
	count := 0
...
func (repository *GormRepository) GetRecordForBank(uow *UnitOfWork, ID uint, out interface{}, queryProcessors ...QueryProcessor) error {
	queryProcessors = append([]QueryProcessor{Filter("id = ?", ID)}, queryProcessors...)
	return repository.GetRecord(uow, out, queryProcessors...)
}

func DoesRecordExistForAccount(db *gorm.DB, ID uint, out interface{}, queryProcessor ...QueryProcessor) (bool, error) {
	if ID == 0 {
		return false, errors.NewValidationError("DoesRecordExistForTenant: Invalid tenant ID")
	}
	count := 0
...
func (repository *GormRepository) GetRecordForAccount(uow *UnitOfWork, ID uint, out interface{}, queryProcessors ...QueryProcessor) error {
	queryProcessors = append([]QueryProcessor{Filter("id = ?", ID)}, queryProcessors...)
	return repository.GetRecord(uow, out, queryProcessors...)
}
